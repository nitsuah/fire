...
- [x] **Branch coverage is below the enforced 70% threshold, and CI doesn't check it.** Fixed 2026-09-24: new `tests/unit/finance-calcs-branches.test.mjs` raised branch coverage to 73.30% (484 tests), and CI now runs `npm run test:coverage`. (P1 · Tech Debt · Confidence: High)
